...
public class LevelHeightBGManager : MonoBehaviour {
	...
	void Update () 
	{
		...
		HeightLimit_1.transform.position = new Vector3 (2, LevelHeight[0] + LevelHeight[1]+ 5  + StartingHeight, 0);
		...
		HeightLimit_2.transform.position = new Vector3 (2, LevelHeight[0] + LevelHeight[1] + LevelHeight[2] + 5  + StartingHeight, 0);
		...
		HeightLimit_3.transform.position = new Vector3 (2, LevelHeight[0] + LevelHeight[1] + LevelHeight[2] + LevelHeight[3]+ 5  + StartingHeight, 0);
		...
		HeightLimit_4.transform.position = new Vector3 (2, LevelHeight[0] + LevelHeight[1] + LevelHeight[2] + LevelHeight[3] + LevelHeight[4]+ 5  + StartingHeight, 0);
